...
const About = () => {
    ...
    const aboutData = [
        { src: bioData.summary.image, title: bioData.summary.title, text: bioData.summary.tag },
        { src: bioData.items[0].image, title: bioData.items[0].title, text: bioData.items[0].text },
        { src: bioData.items[1].image, title: bioData.items[1].title, text: bioData.items[1].text }
    ];
    ...
    const handleScroll = (e) => {
        ...
        if (Math.abs(scrollDistance.current) > 10) {
            ...
            if (scrollDistance.current > 0 && currentIndex < aboutData.length - 1) {
                newIndex++;
    ...
    return (
        <div className="container" onWheel={handleScroll}>
            ...
            <div className="left-div">
                ...
                >
                    <h1 className='title-text'>{aboutData[currentIndex].title}</h1>
                    <p className='tag-text'>{aboutData[currentIndex].text}</p>
            ...
            <div className="right-div" ref={rightDivRef}>
                ...
                {aboutData.map((img, index) => (
                    ...
                    <div className='snap-image'>
                        <img key={index} src={img.src} alt={`Image ${index + 1}`} className="floating-image" />
                    </div>
